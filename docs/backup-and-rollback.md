...
Per questa procedura è fortemente raccomandato avere uno ST-Link disponibile prima di iniziare il flashing.
...
- condividere dump personali o immagini eMMC senza aver rimosso credenziali e dati sensibili.
